function [cost, grad] = softmaxCostSGD(theta,data, labels, numClasses, inputSize, lambda)
...
if groundTruth < numClasses
      groundTruth=[groundTruth;zeros(numClasses-size(groundTruth,1),1)];
end
